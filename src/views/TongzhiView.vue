  ...
  <div class="tongzhi-page-wrapper main-background">
    ...
    <div class="main">
      <el-scrollbar max-height="100%">
        ...
        <div v-else v-for="(article, index) in tongzhiStore.tongzhiArticles" :key="index" class="layout-single-image">
          <div class="layout-single-image-l">
            <div style="color:#333333;" @click="openLink(`/tongzhiContent?id=${article.id}`)">
              {{ article.title }}
            </div>
          ...
          <el-image 
            ...
            fit="cover" 
            class="image-content" 
            @click="openLink(`/tongzhiContent?id=${article.id}`)">
            <template #error>
